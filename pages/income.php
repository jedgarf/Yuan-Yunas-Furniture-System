...
<?php }?>      
      ...
      <?php
      $query1=mysqli_query($con,"select sum(payment) as payment from payment natural join customer where date(payment_date)>='$start' and date(payment_date)<='$end' and branch_id='$branch'")or die(mysqli_error($con));
      while ($row1=mysqli_fetch_array($query1)){
                 $payment1=$row1['payment'];
}
      ?>
				<td><h4><b><?php echo number_format($payment1+$interest-$rebate,2);?></b></h4></td>
			</tr>
	<?php }?>		
